...
Corvex-RedOps is reached via `localhost:8080` port-forwarding either way, so you
...
## Deep-scan backend
Corvex-RedOps's native crawler, OWASP checks, out-of-band detection, and injection
