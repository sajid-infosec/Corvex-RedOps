...
🚀 **v0.1.0 — first release.** The full loop works end-to-end: scope → scan → normalize → validate → prioritize → report, across seven asset modules (infra, web, WordPress, API, mobile, desktop, network devices). See the [Quickstart](docs/QUICKSTART.md), [Demo](docs/DEMO.md), and [CHANGELOG](CHANGELOG.md). Earlier context: Working now: the
